...
class ProjectModelEditorTests {
    ...
    void testAddDuplicateDependency() {
        ...
        boolean firstAdd = pomEditor.addDependency(model, "org.junit.jupiter", "junit-jupiter", "5.9.2");
        assertTrue(firstAdd);
        assertEquals(1, model.getDependencies().size());
        
        // Try to add same dependency again
        boolean secondAdd = pomEditor.addDependency(model, "org.junit.jupiter", "junit-jupiter", "5.8.2");
