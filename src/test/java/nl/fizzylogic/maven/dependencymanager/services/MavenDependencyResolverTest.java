...
class MavenDependencyResolverTest {
  ...
  @Mock private MavenRepositorySearch repositorySearch;
  ...
  void testDependencyExistsWithValidVersion() throws Exception {
    ...
    boolean exists =
        resolverService.dependencyExists("org.junit.jupiter", "junit-jupiter", "5.8.2");
  ...
  void testDependencyExistsWithInvalidVersion() throws Exception {
    ...
    boolean exists =
        resolverService.dependencyExists("org.junit.jupiter", "junit-jupiter", "99.99.99");
  ...
  void testResolveDependencyWithVersion() throws Exception {
    ...
    ResolvedDependency resolved = resolverService.resolveDependency(coordinates);
